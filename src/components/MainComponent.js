...
import { postFeedback, postComment, fetchPartners, fetchCampsites, fetchComments, fetchPromotions } from '../redux/ActionCreators';
...
const mapDispatchToProps = {
  ...
  postFeedback: (id, firstName, lastName, phoneNum, email, agree, contactType, feedback)=> (
    postFeedback(id, firstName, lastName, phoneNum, email, agree, contactType, feedback))
};
